                                                        ...
                                                        <table class="table center-aligned-table mb-0">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                @foreach ($Grade->sections as $list_Sections)
                                                                    {{-- this is name of relation in model --}}
                                                                    {{-- عشان يجبلي كل مرحلة فيها الاقسام بتاعتها --}}
                                                                    <tr>
                                                                        <?php $i++; ?>
                                                                        <td>{{ $i }}</td>
                                                                                ...
                                                                                <div class="modal-body">
                                                                                    ...
                                                                                    <div class="modal-footer">
                                                                                        <button type="button"
                                                                                            class="btn btn-secondary"
                                                                                            data-dismiss="modal">{{ trans('Sections_trans.Close') }}</button>
                                                                                        <a href="{{ route('section.destroy', $list_Sections->id) }}"
                                                                                            type="submit"
                                                                                            class="btn btn-danger">{{ trans('Sections_trans.submit') }}</a>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
